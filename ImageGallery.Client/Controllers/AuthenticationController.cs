...
namespace ImageGallery.Client.Controllers
{
    public class AuthenticationController : Controller
    {
        ...
        public async Task Logout()
        {
            ...
            var refeshTokenRevocationResponse = await client.RevokeTokenAsync(new TokenRevocationRequest()
            {
                Address = discoveryDocumentResponse.RevocationEndpoint,
                ClientId = "imagegalleryclient",
                ClientSecret = "secret",
            ...
            if (refeshTokenRevocationResponse.IsError)
            {
                throw new Exception(refeshTokenRevocationResponse.Error);
            }
